        ...
        <Box className="welcome-parent-wrapper">
            <Box className="welcome-wrapper">
                ...
                <Box className="bottom-section">
                    ...
                    <TextField id="outlined-basic" label="Phone no." size='small' variant="outlined" fullWidth />
                    <TextField id="outlined-basic" label="Organization name" size='small' variant="outlined" fullWidth />
                    <TextField id="outlined-basic2" label="Website" size='small' variant="outlined" fullWidth />
